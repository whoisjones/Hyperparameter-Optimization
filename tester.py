...
grid = optimizers.GridSearchOptimizer(search_space=search_space)
optimizer = optimizers.GeneticOptimizer(search_space=search_space, population_size=12)
rand = optimizers.RandomSearchOptimizer(search_space=search_space)
